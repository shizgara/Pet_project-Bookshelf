...
CLOUDSQL_PASSWORD = 'bookshelf'
CLOUDSQL_DATABASE = 'bookshelf'
# Set this value to the Cloud SQL connection name, e.g.
#   "project:region:cloudsql-instance".
# You must also update the value in app.yaml.
CLOUDSQL_CONNECTION_NAME = 'gcp-2022-bookshelf-gurskyi:europe-west1:bookshelf-db-tf-faf310e2'
...
CLOUD_STORAGE_BUCKET = 'tf-bucket-for-content'
